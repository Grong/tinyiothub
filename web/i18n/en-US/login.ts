const translation = {
  ...
  welcome: '👋 Welcome to Tiny IoTHub, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Tiny IoTHub Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Tiny IoTHub',
  invalid: 'The link has expired',
  explore: 'Explore Tiny IoTHub',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Tiny IoTHub and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Tiny IoTHub Enterprise license for your workspace has expired. Please contact your administrator to continue using Tiny IoTHub.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Tiny IoTHub license server. Please contact your administrator to continue using Tiny IoTHub.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Tiny IoTHub Enterprise license for your workspace is inactive. Please contact your administrator to continue using Tiny IoTHub.',
  webapp: {
