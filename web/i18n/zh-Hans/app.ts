const translation = {
  ...
  newApp: {
    ...
    parkShortDescription: '园区物联网平台应用',
    parkUserDescription: '基于园区智能化物联网设备应用的场景。',
    computerRoomShortDescription: '机房物联网平台应用',
    computerRoomUserDescription: '基于机房智能化物联网设备应用的场景。',
