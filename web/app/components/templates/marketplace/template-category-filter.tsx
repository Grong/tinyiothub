...
const TemplateCategoryFilter: React.FC = () => {
  ...
  const categories = [
    ...
    {
      value: 'sensors' as TemplateCategory,
      text: '传感器',
      icon: <RiSensorLine className="mr-1.5 h-4 w-4" />,
    },
    {
      value: 'controllers' as TemplateCategory,
      text: '控制器',
      icon: <RiSettings3Line className="mr-1.5 h-4 w-4" />,
    },
    {
      value: 'cameras' as TemplateCategory,
      text: '摄像头',
      icon: <RiCameraLine className="mr-1.5 h-4 w-4" />,
    },
    {
      value: 'gateways' as TemplateCategory,
      text: '网关',
