      ...
      <section className="relative pt-28 pb-20">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex justify-center mb-6">
            <div className="rounded-full border border-purple-200/50 bg-gradient-to-r from-purple-50/80 to-blue-50/80 backdrop-blur-xl px-5 py-2 text-sm text-purple-700 shadow-lg dark:border-purple-500/30 dark:bg-black/70 dark:text-purple-300 dark:shadow-none">
