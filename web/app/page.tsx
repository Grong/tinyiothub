        ...
        <div className="px-4 md:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              {isAuthenticated ? (
                <a href="/dashboard" className="rounded-lg bg-components-button-primary-bg text-components-button-primary-text px-5 py-2.5 text-sm font-semibold hover:bg-components-button-primary-bg-hover transition-all dark:opacity-90">控制台</a>
              ) : (
                <>
