...
export default function MonitoringPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-text-primary">{t('pages.monitoring.title')}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-components-panel-bg shadow rounded-lg border border-divider-subtle">
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg leading-6 font-medium text-text-primary">
              {t('pages.monitoring.sections.realTimeData')}
            </h3>
            <div className="mt-5">
        ...
        <div className="bg-components-panel-bg shadow rounded-lg border border-divider-subtle">
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg leading-6 font-medium text-text-primary">
              {t('pages.monitoring.sections.systemPerformance')}
            </h3>
            <div className="mt-5">
              <div className="text-center py-12 text-text-tertiary">
                {t('dashboard.sections.comingSoon')}
