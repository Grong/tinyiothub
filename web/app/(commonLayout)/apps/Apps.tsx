...
const Apps = () => {
  ...
  const options = [
    ...
    { value: 'park', text: t('app.types.park'), icon: <RiMessage3Line className='mr-1 h-[14px] w-[14px]' /> },
    { value: 'computer-room', text: t('app.types.computerRoom'), icon: <RiRobot3Line className='mr-1 h-[14px] w-[14px]' /> },
  ]
