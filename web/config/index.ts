...
if (
  ...
  apiPrefix = 'http://localhost:5150/console/api'
  publicApiPrefix = 'http://localhost:5150/api' // avoid browser private mode api cross origin
...
export const ENABLE_WEBSITE_JINAREADER
  = process.env.NEXT_PUBLIC_ENABLE_WEBSITE_JINAREADER !== undefined
...
export const ENABLE_WEBSITE_FIRECRAWL
  = process.env.NEXT_PUBLIC_ENABLE_WEBSITE_FIRECRAWL !== undefined
    ? process.env.NEXT_PUBLIC_ENABLE_WEBSITE_FIRECRAWL === 'true'
    : globalThis.document?.body?.getAttribute(
        'data-public-enable-website-firecrawl',
      ) === 'true' || true

export const ENABLE_WEBSITE_WATERCRAWL
  = process.env.NEXT_PUBLIC_ENABLE_WEBSITE_WATERCRAWL !== undefined
