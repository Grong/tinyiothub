...
export class ChatView extends LitElement {
  ...
  private _suggestions = [
    { icon: 'M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z', text: '查看所有物状态' },
  ...
  private _renderWelcome() {
    return html`
      <div class="chat-welcome">
        ...
        <p class="chat-welcome__desc">我是您的 IoT 智能助手，可以帮助您管理物、分析数据、处理告警等。请选择下方问题或直接输入内容开始对话。</p>
