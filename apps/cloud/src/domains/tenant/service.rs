...
impl TenantService {
    ...
    pub async fn get_api_usage_stats(&self, tenant_id: &str, days: i32) -> Result<ApiUsageStats> {
        self.db.get_api_usage_stats(tenant_id, days).await
    }
}
