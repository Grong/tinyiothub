...
fn test_workspace_file_info_serde() {
    use crate::domains::agent::host::handler::files::{WorkspaceFileInfo, WorkspaceFileResponse};
...
fn test_update_request_deserialization() {
    use crate::domains::agent::host::handler::files::UpdateWorkspaceFileRequest;
...
fn test_file_size_limit() {
    use crate::domains::agent::host::handler::files::MAX_FILE_SIZE;
