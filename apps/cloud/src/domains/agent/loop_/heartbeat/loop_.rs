...
async fn run_heartbeat_tick(
    ...
    agent_pool: &Arc<dyn crate::domains::agent::loop_::agent::pool::AgentPoolLike>,
    ...
    result.executed_actions = output
        .tool_calls
        .into_iter()
        .map(|c| crate::domains::agent::loop_::heartbeat::types::ExecutedAction {
...
mod tests {
    ...
    use crate::domains::agent::loop_::heartbeat::types::HeartbeatTask;
    use std::sync::Mutex;
    ...
    async fn executed_actions_come_from_actual_tool_calls_not_llm_report() {
        ...
        let metrics = crate::domains::agent::loop_::heartbeat::metrics::Metrics::new();
    ...
    fn sample_signal() -> crate::domains::agent::loop_::heartbeat::types::HeartbeatSignal {
        crate::domains::agent::loop_::heartbeat::types::HeartbeatSignal {
            workspace_id: "ws".into(),
            reason: "test".into(),
            context: String::new(),
            priority: crate::domains::agent::loop_::heartbeat::types::SignalPriority::High,
            device_id: None,
            alarm_type: None,
            rule_id: None,
        }
    ...
    async fn paused_loop_updates_paused_metric_and_resumes() {
        ...
        let metrics = Arc::new(crate::domains::agent::loop_::heartbeat::metrics::Metrics::new());
