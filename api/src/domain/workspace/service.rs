...
impl WorkspaceService {
    ...
    pub async fn update(&self, id: &str, name: Option<&str>, description: Option<&str>, agent_config: Option<&str>) -> Result<Option<WorkspaceWithDeviceCount>> { self.repository.update(id, name, description, agent_config).await }
