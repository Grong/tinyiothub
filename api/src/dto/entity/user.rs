...
impl User {
    ...
    /// 验证密码
    pub fn verify_password(&self, password: &str) -> crate::shared::error::Result<bool> {
        crate::shared::utils::password::verify_password(password, &self.password_hash)
            .map_err(|e| crate::shared::error::Error::ValidationError(format!("password verification failed: {}", e)))
    }
