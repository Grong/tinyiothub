...
use crate::domain::alarm::SortOrder;
...
impl ToolHandler for AlarmRuleAddHandler {
    ...
    async fn execute(&self, args: Value) -> Result<Value, ToolError> {
        ...
        let rule_type = match input.rule_type.as_str() {
            "threshold" => crate::domain::alarm::RuleType::Threshold,
            "range" => crate::domain::alarm::RuleType::Range,
            "change" => crate::domain::alarm::RuleType::Change,
            "duration" => crate::domain::alarm::RuleType::Duration,
            "composite" => crate::domain::alarm::RuleType::Composite,
