// Agent Client — adapter between TinyIoTHub HTTP API and AI Agent backends
//
// This module provides shared types and utilities for agent functionality.
// The actual runtime implementation is in zeroclaw_runtime.rs (TinyIoTHubAgentClient).
...
/// Trait for Agent operations — implemented by TinyIoTHubAgentClient in zeroclaw_runtime.rs
