...
//!   handlers; auth consumes it via [`crate::sse::SseTokenIssuer`]. Reclaim: Task 18 (event crate).
...
//!   [`crate::user_store::AuthUserStore`]; cloud maps types until the user domain extraction.
//!   Reclaim: Task 17.
...
//!   [`crate::bootstrap::WorkspaceBootstrap`]. Reclaim: Task 17 or Task 24.
