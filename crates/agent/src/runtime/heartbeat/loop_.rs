...
async fn run_heartbeat_tick(
    ...
    agent_pool: &Arc<dyn crate::runtime::agent::pool::AgentPoolLike>,
...
mod tests {
    use super::*;
    use crate::runtime::agent::pool::{AgentPoolLike, AgentRunOutput, ToolCallRecord};
    use crate::runtime::heartbeat::types::HeartbeatTask;
    use std::sync::Mutex;
    ...
    async fn executed_actions_come_from_actual_tool_calls_not_llm_report() {
        ...
        let metrics = crate::runtime::heartbeat::metrics::Metrics::new();
    ...
    fn sample_signal() -> crate::runtime::heartbeat::types::HeartbeatSignal {
        crate::runtime::heartbeat::types::HeartbeatSignal {
            workspace_id: "ws".into(),
            reason: "test".into(),
            context: String::new(),
