...
// state.rs:       AgentState composition slice
    ...
    AgentState: axum::extract::FromRef<S>,
{
    Router::new()
        ...
        .nest("/chat", crate::chat::handler::create_router())
        .route("/tools/catalog", get(crate::chat::handler::proxy::tools_catalog))
        .route("/tools/effective", get(crate::chat::handler::proxy::tools_effective))
        .route("/tools/toggle", post(crate::chat::handler::proxy::tools_toggle))
}
