...
impl From<crate::host::shared::AgentError> for ChatError {
    fn from(err: crate::host::shared::AgentError) -> Self {
...
/// DEPRECATED: Use `crate::host::session::SessionKey` instead.
...
mod tests {
    ...
    fn test_chat_error_from_agent_error() {
        let agent_err = crate::host::shared::AgentError::RequestFailed("test error".to_string());
