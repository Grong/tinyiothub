...
/// composition layer (see `crate::host::ports::set_minimax_settings`).
pub fn minimax_provider_factory() -> ProviderFactory {
    Arc::new(crate::host::ports::create_minimax_provider)
}
...
impl AutonomousAgentFactory {
    ...
    pub async fn get_or_create(
        ...
        let agent = zeroclaw::agent::Agent::builder()
            ...
            .workspace_dir(crate::host::shared::paths::workspace_dir(workspace_id))
            .build()
