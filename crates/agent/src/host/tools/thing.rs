...
pub struct ReadPropertyTool {
    ...
    pool: SqlitePool,
    workspace_id: String,
    device_cache: Option<Arc<tinyiothub_storage::cache::DeviceCache>>,
}
...
mod tests {
    ...
    fn test_invoke_action_rejects_non_device_type_in_schema() {
        ...
        assert_eq!(
            crate::loop_::types::classify_tool_safety("invoke_action"),
            ToolSafety::Write,
    ...
    fn test_classify_tool_safety_by_name() {
        use crate::loop_::types::classify_tool_safety;
