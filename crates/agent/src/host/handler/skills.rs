...
use crate::host::shared::paths::{self, global_skills_dir, workspace_skills_dir};
...
where
    ...
    crate::host::state::AgentState: axum::extract::FromRef<S>,
{
    Router::new()
...
pub async fn get_skill(
    ...
    match fs::read_to_string(&file_path).await {
        Ok(content) => {
            let (fm, body) = crate::host::skill::AgentSkill::parse_frontmatter(&content);
...
mod tests {
    ...
    use crate::host::skill::AgentSkill;
