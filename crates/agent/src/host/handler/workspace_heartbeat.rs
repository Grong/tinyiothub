...
pub async fn approve_proposal(
    ...
    let Some(registry) = crate::host::ports::external_tool_registry() else {
...
async fn approve_and_execute(
    ...
    workspace_id: &str,
    proposal_id: &str,
    registry: &std::sync::Arc<dyn crate::host::ports::ExternalToolRegistry>,
    ...
    let ctx = crate::host::ports::ExternalToolContext {
...
mod tests {
    ...
    use super::*;
    use crate::host::ports::{ExternalToolContext, ExternalToolHandler, ExternalToolMeta, ExternalToolRegistry};
