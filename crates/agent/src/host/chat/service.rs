...
use crate::host::types::{ChatError, ChatEvent};
...
pub async fn send_message(
    ...
    let (turn_message, reflect_message) = {
        ...
        let skills = crate::host::agent::load_workspace_skills(&ws_dir);
    ...
    let handle = tokio::spawn(async move {
            ...
            && let Some(ms) = memory_service
        {
            let turn_messages = vec![
                crate::loop_::session::types::ChatTurnMessage {
                    role: "user".into(),
            ...
            tokio::spawn(async move {
                    ...
                    .await
                {
                    ...
                    if let Some(ref ep) = ep {
                        ep.publish(crate::loop_::event::types::AiEvent::ReflectionFailed {
