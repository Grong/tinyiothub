...
use crate::loop_::thing_agent::prompt::build_prompt;
use crate::loop_::thing_agent::pushback::deliver;
use crate::loop_::thing_agent::report::AgentRunsRepository;
use crate::loop_::thing_agent::runner::{AgentHandle, RunContext, RunContextInner, Runner};
use crate::loop_::thing_agent::scheduler::{EnqueueError, Scheduler, SchedulerHandle};
use crate::loop_::thing_agent::traits::{DirectiveSink, ThingAgentHost};
use crate::loop_::thing_agent::trigger::{ThingEventTrigger, TimerTrigger, Trigger};
use crate::loop_::thing_agent::types::{TriggerSource, WakeSignal};
...
impl Default for ThingAgentManagerConfig {
    fn default() -> Self {
        Self {
            ...
            min_wake_level: 3,
            merge_window: crate::loop_::thing_agent::scheduler::MERGE_WINDOW,
        }
    }
}
...
pub(crate) mod tests {
    ...
    use crate::loop_::thing_agent::traits::ThingEventSignal;
    use crate::loop_::thing_agent::types::{Outcome, Priority, RunReport};
