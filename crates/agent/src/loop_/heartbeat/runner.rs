...
use crate::loop_::agent::pool::AgentPoolLike;
...
impl HeartbeatRunner {
    ...
    pub async fn effective_interval_minutes(&self, workspace_id: &str) -> u32 {
        match self.task_repo.load_heartbeat_config(workspace_id).await {
            Ok(Some(cfg)) => cfg
                .interval_minutes
                .max(crate::loop_::heartbeat::types::MIN_HEARTBEAT_INTERVAL_MINUTES),
...
mod tests {
    ...
    impl AgentPoolLike for PanicPool {
        ...
        async fn send_message(
            ...
            _workspace_id: &str,
            _prompt: &str,
        ) -> anyhow::Result<crate::loop_::agent::pool::AgentRunOutput> {
    ...
    impl AgentPoolLike for OkPool {
        ...
        async fn send_message(
            ...
            Ok(crate::loop_::agent::pool::AgentRunOutput {
