...
INSERT OR IGNORE INTO subscription_plans (id, name, display_name, description, device_limit, api_call_limit, storage_mb, user_limit, price_monthly, price_yearly, features, sort_order) VALUES
...
('builtin-modbus-rtu-device', 'modbus_rtu_device', '{"zh": "Modbus RTU设备", "en": "Modbus RTU Device"}', '{"zh": "标准Modbus RTU协议设备模板，支持寄存器读写操作", "en": "Standard Modbus RTU protocol device template with register read/write operations"}', '1.0.0', 'System', 'controllers', NULL, 'controller', 'device', 'modbus', 'modbus_rtu', '["modbus", "rtu", "controller", "industrial"]', '{"default_name_pattern": "modbus_device_{index}", "default_display_name_pattern": "Modbus设备 {index}", "default_description": {"zh": "Modbus RTU工业设备", "en": "Modbus RTU Industrial Device"}, "required_fields": ["name", "address"]}', '[
        {
...
('builtin-smart-switch', 'smart_switch', '{"zh": "智能开关", "en": "Smart Switch"}', '{"zh": "智能开关设备模板，支持开关状态控制和电流监测", "en": "Smart switch device template with switch control and current monitoring"}', '1.0.0', 'System', 'controllers', NULL, 'switch', 'device', 'wifi', 'wifi_switch', '["switch", "smart", "control", "power"]', '{"default_name_pattern": "switch_{index}", "default_display_name_pattern": "智能开关 {index}", "default_description": {"zh": "智能电源开关", "en": "Smart Power Switch"}, "required_fields": ["name", "address"]}', '[
        {
            "name": "switch_state",
