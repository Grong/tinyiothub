...
use crate::modules::self_healing::handler::get_self_healing_state;
use crate::modules::self_healing::{RecoveryActionType, SeverityLevel};
use crate::modules::workspace::WorkspaceRepository;
use crate::modules::self_healing::types::{ExecuteSelfHealRequest, SelfHealingPolicyDto};
...
impl ToolHandler for GetSelfHealPolicyHandler {
    ...
    async fn execute(&self, _args: Value) -> Result<Value, ToolError> {
        ...
        let _claims = crate::modules::mcp::handlers::get_mcp_context().ok_or_else(|| {
...
impl ToolHandler for GetRecoveryHistoryHandler {
    ...
    async fn execute(&self, args: Value) -> Result<Value, ToolError> {
        ...
        let (tenant_id, _workspace_id) = if let Some(ctx) = crate::modules::mcp::handlers::get_mcp_context() {
            let repo = crate::modules::workspace::SqliteWorkspaceRepository::new(db.as_ref().clone());
...
pub fn register_self_heal_tools(registry: &mut crate::modules::mcp::tool_registry::HandlerRegistry) {
