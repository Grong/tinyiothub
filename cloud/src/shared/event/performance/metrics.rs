...
impl PerformanceMetricsCollector {
    ...
    pub async fn get_metrics(&self) -> EventPerformanceMetrics {
        ...
        let events_per_second =
            if elapsed_seconds > 0.0 { total_events as f64 / elapsed_seconds } else { 0.0 };
        ...
        let avg_processing_time_ms =
            if total_events > 0 { total_processing_time as f64 / total_events as f64 } else { 0.0 };

        let avg_query_time_ms =
            if total_queries > 0 { total_query_time as f64 / total_queries as f64 } else { 0.0 };
        ...
        EventPerformanceMetrics {
            ...
            peak_processing_time_ms: self.peak_processing_time_ms.load(Ordering::Relaxed) as f64
                / 1000.0,
...
mod tests {
    ...
    async fn test_metrics_collection() {
        ...
        collector
            .record_error("database_error".to_string(), "Connection timeout".to_string(), context)
            .await;
