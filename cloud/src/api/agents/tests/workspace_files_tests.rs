...
fn test_workspace_file_info_serde() {
    use crate::api::agents::files::{WorkspaceFileInfo, WorkspaceFileResponse};
...
fn test_update_request_deserialization() {
    use crate::api::agents::files::UpdateWorkspaceFileRequest;
...
fn test_file_size_limit() {
    use crate::api::agents::files::MAX_FILE_SIZE;
