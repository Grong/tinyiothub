...
**DO NOT use `{component: "device_card", data: {...}}` — this will NOT render.**
...
dataModel: {
  ...
  properties: [                // Key-value pairs to display
    ...
    { key: "运动速度", value: "44.65", unit: "%" }
  ],
  telemetry?: [{ key, value, unit }],
  actions?: [{ label: "启动程序", functionId: "start_program" }]
}
```
